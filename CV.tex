\documentclass{dsemenov_cv}

\defaultfontfeatures{Ligatures={TeX},Renderer=Basic}  %% свойства шрифтов по умолчанию
\setmainfont[Ligatures={TeX,Historic}]{Liberation Serif} %% задаёт основной шрифт документа
\setmonofont{Liberation Mono}

\setname{Dmitry}{Semenov}
\setaddress{Novosibirsk/Russia}
\setmobile{+7-923-157-0017}
\setmail{dsemenov87@gmail.com}
\setposition{Work Student} %ignored for now
\setlinkedinaccount{https://www.linkedin.com/in/dsemenov-568a96b1/} %you can play with color of the template (red is also nice..)
\setgithubaccount{https://github.com/dsemenov87} %you can play with color of the template (red is also nice..)
...
\addblocktext{Summary}{%
    Занимаюсь разработкой на .NET с 2012 года
}
%
%Education
\section{Education} 
